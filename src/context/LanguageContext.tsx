...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    'nav.polygonDid': 'Decentralized DID (Polygon)',
    'polygonDid.badge': 'POLYGON (PoS) ANCHORED DECENTRALIZED IDENTITY',
    'polygonDid.title': 'Decentralized Identity & On-Chain Key Fingerprints',
    'polygonDid.subtitle': 'Immutable public proof-of-ownership for user public keys on the Polygon PoS blockchain. Zero metadata leakage, cryptographic Merkle inclusion proofs, and sovereign hardware enclave attestation.',
    'realtimeDashboard.badge': 'LIVE TELEMETRY DASHBOARD',
    'realtimeDashboard.title': 'Real-Time Cryptographic Enclave Telemetry',
    'realtimeDashboard.subtitle': 'Continuous monitoring of global hardware enclaves, lattice key negotiations, and zero-knowledge tunnel health.',
    'publicVerification.badge': 'PUBLIC CRYPTOGRAPHIC VERIFICATION',
    'publicVerification.title': 'Independent Public Session & Key Verifier',
    'publicVerification.subtitle': 'Inspect and verify post-quantum ephemeral session proofs, NIST FIPS 203 parameters, and non-interactive zero-knowledge proofs in real-time.',
    'transparencyLedger.badge': 'IMMUTABLE AUDIT LOG',
    'transparencyLedger.title': 'Real-Time Immutable Transparency Ledger',
    'transparencyLedger.subtitle': 'Cryptographically chained verification events with Zero-Knowledge proofs, proving tamper resistance without exposing participant identities.',
    'auditTrail.badge': 'INDEPENDENT SECURITY AUDIT TRAIL',
    'auditTrail.title': '10 Cryptographic Audits & Technical Verification Reports',
    'auditTrail.subtitle': 'Independently evaluated by world-leading cryptographic laboratories (ANSSI, BSI, NIST, Trail of Bits, Quarkslab, Kudelski).',
    'anonymizedRouting.badge': 'QUANTUM MIXNET ROUTING',
    'anonymizedRouting.title': 'Multi-Hop Anonymized Mixnet & Traffic Shielding',
    'anonymizedRouting.subtitle': 'Sphinx-wrapped cryptographic packet onion routing across sovereign European nodes, defeating metadata correlation and ISP surveillance.',
    'latticeVsClassical.badge': 'MATHEMATICAL HARDNESS COMPARISON',
    'latticeVsClassical.title': 'Lattice-Based Cryptography vs Classical RSA/ECC',
    'latticeVsClassical.subtitle': 'Why Learning With Errors (LWE) and Module-LWE provide unbreakable security against Shor\'s Algorithm where prime factorization completely fails.',
    'academicAffiliations.badge': 'RESEARCH & ACADEMIC COLLABORATION',
    'academicAffiliations.title': 'Academic Affiliations & Cryptographic Peer Review',
    'academicAffiliations.subtitle': 'Partnered with top European and global research institutes (INRIA, CNRS, ETH Zurich, MIT CSAIL) to validate lattice noise distributions and side-channel immunity.',
    'quantumReadiness.badge': 'ORGANIZATIONAL READINESS AUDIT',
    'quantumReadiness.title': 'Organizational Quantum Readiness Calculator',
    'quantumReadiness.subtitle': 'Evaluate your institution\'s exposure to Harvest-Now-Decrypt-Later (HNDL) attacks and obtain an immediate migration roadmap under NIST and ANSSI guidelines.',
    ...
    'hero.plainEnglishBody': 'Standard messaging apps (WhatsApp, Signal, Teams) rely on RSA and Elliptic Curve mathematics that will be retroactively broken by quantum supercomputers via "Harvest Now, Decrypt Later" (HNDL) attacks. Q-CRYPT deploys NIST FIPS 203 (ML-KEM-1024) lattice encryption and hardware enclaves (Titan M2 / Knox StrongBox) to guarantee that board deliberations, M&A strategies, and institutional secrets remain cryptographically impervious for 50+ years.',
    'hero.plainEnglishTitle': 'Executive Overview: Post-Quantum Resilience & Fiduciary Defense',
    ...
    'preflight.badge': 'HARDWARE PRE-FLIGHT VERIFICATION',
    'preflight.title': 'Pre-Flight Security Checklist & Enclave Enrollment',
    'preflight.subtitle': 'Verifies hardware-backed keystore integrity (Titan M2/Knox) and enrolls device in forensic tamper ledger.',
    'adversary.badge': 'QUANTUM ADVERSARY SIMULATOR',
    'adversary.title': 'Quantum Adversary Simulator & HNDL Risk Engine',
    'adversary.subtitle': 'Real-world quantum computing milestones mapped against lattice hardness and Harvest-Now, Decrypt-Later attack vectors.',
    'hsmGuide.badge': 'FIPS 140-3 ARCHITECTURE & PROCUREMENT',
    'hsmGuide.title': 'Hardware Security Module (HSM) Selection Guide',
    'hsmGuide.subtitle': 'Engineering specifications, security boundaries, and native code integration samples for Titan M2, YubiKey, Nitrokey, and Cloud HSMs.',
  },
  fr: {
    'nav.polygonDid': 'Identité Décentralisée (DID)',
    'polygonDid.badge': 'IDENTITÉ DÉCENTRALISÉE ANCRÉE SUR POLYGON (PoS)',
    'polygonDid.title': 'Identité Décentralisée & Ancrage d\'Empreintes Post-Quantiques',
    'polygonDid.subtitle': 'Preuve publique immuable de propriété des clés publiques sur la blockchain Polygon PoS. Zéro fuite de métadonnées, preuves d\'inclusion Merkle cryptographiques et attestation d\'enclave matérielle souveraine.',
    'realtimeDashboard.badge': 'TABLEAU DE BORD TÉLÉMÉTRIE EN DIRECT',
    'realtimeDashboard.title': 'Télémétrie des Enclaves Cryptographiques en Temps Réel',
    'realtimeDashboard.subtitle': 'Surveillance continue des enclaves matérielles mondiales, des négociations de clés sur réseaux euclidiens et des tunnels zéro-connaissance.',
    'publicVerification.badge': 'VÉRIFICATION CRYPTOGRAPHIQUE PUBLIQUE',
    'publicVerification.title': 'Vérificateur Public Indépendant de Sessions & Clés',
    'publicVerification.subtitle': 'Inspectez et vérifiez en temps réel les preuves de sessions éphémères post-quantiques, les paramètres NIST FIPS 203 et les preuves à divulgation nulle de connaissance.',
    'transparencyLedger.badge': 'REGISTRE D\'AUDIT IMMUABLE',
    'transparencyLedger.title': 'Registre de Transparence Immuable en Temps Réel',
    'transparencyLedger.subtitle': 'Événements de vérification chaînés cryptographiquement avec preuves ZK, garantissant l\'inviolabilité sans révéler l\'identité des participants.',
    'auditTrail.badge': 'PISTE D\'AUDIT DE SÉCURITÉ INDÉPENDANTE',
    'auditTrail.title': '10 Rapports d\'Audits Cryptographiques & Vérifications Techniques',
    'auditTrail.subtitle': 'Évalué de façon indépendante par les plus grands laboratoires cryptographiques mondiaux (ANSSI, BSI, NIST, Trail of Bits, Quarkslab, Kudelski).',
    'anonymizedRouting.badge': 'ROUTAGE MIXNET QUANTIQUE ANONYMISÉ',
    'anonymizedRouting.title': 'Mixnet Multi-Sauts Anonymisé & Blindage de Trafic',
    'anonymizedRouting.subtitle': 'Routage en oignon avec paquets cryptographiques Sphinx sur des nœuds souverains européens, éliminant la corrélation de métadonnées et la surveillance FAI.',
    'latticeVsClassical.badge': 'COMPARAISON DE COMPLEXITÉ MATHÉMATIQUE',
    'latticeVsClassical.title': 'Cryptographie sur Réseaux Euclidiens vs RSA/ECC Classique',
    'latticeVsClassical.subtitle': 'Pourquoi l\'apprentissage avec erreurs (LWE) et Module-LWE garantissent une immunité absolue contre l\'algorithme de Shor là où la factorisation première s\'effondre.',
    'academicAffiliations.badge': 'COLLABORATION ACADÉMIQUE & RECHERCHE',
    'academicAffiliations.title': 'Affiliations Académiques & Évaluation Cryptographique par les Pairs',
    'academicAffiliations.subtitle': 'En partenariat avec les plus grands instituts de recherche européens et internationaux (INRIA, CNRS, ETH Zurich, MIT CSAIL) pour valider les distributions de bruit et l\'immunité aux canaux auxiliaires.',
    'quantumReadiness.badge': 'AUDIT DE MATURITÉ POST-QUANTIQUE',
    'quantumReadiness.title': 'Calculateur de Maturité Post-Quantique pour Organisations',
    'quantumReadiness.subtitle': 'Évaluez l\'exposition de votre institution aux attaques HNDL et obtenez une feuille de route de migration immédiate conforme aux recommandations ANSSI et NIST.',
    ...
    'hero.plainEnglishBody': 'Les applications classiques (WhatsApp, Signal, Teams) reposent sur des mathématiques RSA et courbes elliptiques vouées à être compromises rétroactivement par les supercalculateurs quantiques via les attaques "Récolter Maintenant, Déchiffrer Plus Tard" (HNDL). Q-CRYPT intègre la cryptographie sur réseaux euclidiens NIST FIPS 203 (ML-KEM-1024) et l\'isolation en enclave matérielle (Titan M2 / Knox) pour garantir que les délibérations de conseil d\'administration, les négociations M&A et les secrets stratégiques demeurent inviolables pendant plus de 50 ans.',
    'hero.plainEnglishTitle': 'Vue d\'Ensemble Exécutive : Résilience Post-Quantique & Protection Fiduciaire',
    ...
    'preflight.badge': 'CONTRÔLE PRÉ-VOL MATÉRIEL',
    'preflight.title': 'Contrôle de Sécurité Pré-Vol & Enrôlement d\'Enclave',
    'preflight.subtitle': 'Vérifie l\'intégrité du magasin de clés matériel (Titan M2/Knox) et enregistre le terminal dans le registre d\'intégrité forensique.',
    'adversary.badge': 'SIMULATEUR D\'ADVERSAIRE QUANTIQUE',
    'adversary.title': 'Simulateur d\'Adversaire Quantique & Moteur de Risque HNDL',
    'adversary.subtitle': 'Jalons réels de calcul quantique corrélés à la robustesse des réseaux euclidiens et aux vecteurs d\'attaque Récolter Maintenant, Déchiffrer Plus Tard.',
    'hsmGuide.badge': 'ARCHITECTURE & SÉLECTION FIPS 140-3',
    'hsmGuide.title': 'Guide de Sélection des Modules de Sécurité Matérielle (HSM)',
    'hsmGuide.subtitle': 'Spécifications d\'ingénierie, frontières de sécurité et exemples de code natifs pour Titan M2, YubiKey, Nitrokey et HSM Cloud.',
  },
  de: {
    'nav.polygonDid': 'Dezentrale Identität (DID)',
    'polygonDid.badge': 'AUF POLYGON (PoS) VERANKERTE DEZENTRALE IDENTITÄT',
    'polygonDid.title': 'Dezentrale Identität & On-Chain Post-Quanten-Schlüssel',
    'polygonDid.subtitle': 'Unveränderlicher öffentlicher Eigentumsnachweis für öffentliche Schlüssel auf der Polygon PoS-Blockchain. Keine Metadaten-Lecks, kryptografische Merkle-Inklusionsnachweise und souveräne Hardware-Enklaven-Attestierung.',
    'realtimeDashboard.badge': 'ECHTZEIT-TELEMETRIE-DASHBOARD',
    'realtimeDashboard.title': 'Echtzeit-Telemetrie Kryptografischer Enklaven',
    'realtimeDashboard.subtitle': 'Kontinuierliche Überwachung weltweiter Hardware-Enklaven, Gitter-Schlüsselaushandlungen und Zero-Knowledge-Tunnel.',
    'publicVerification.badge': 'ÖFFENTLICHE KRYPTOGRAFISCHE VERIFIKATION',
    'publicVerification.title': 'Unabhängige Öffentliche Sitzungs- & Schlüsselprüfung',
    'publicVerification.subtitle': 'Überprüfen Sie ephemere Post-Quanten-Sitzungsnachweise, NIST FIPS 203-Parameter und Zero-Knowledge-Beweise in Echtzeit.',
    'transparencyLedger.badge': 'UNVERÄNDERLICHES AUDIT-PROTOKOLL',
    'transparencyLedger.title': 'Unveränderliches Echtzeit-Transparenzbuch',
    'transparencyLedger.subtitle': 'Kryptografisch verkettete Verifikationsereignisse mit ZK-Nachweisen, die Manipulationssicherheit beweisen, ohne Identitäten offenzulegen.',
    'auditTrail.badge': 'UNABHÄNGIGER SICHERHEITSAUDIT-VERLAUF',
    'auditTrail.title': '10 Kryptografische Audits & Technische Prüfberichte',
    'auditTrail.subtitle': 'Unabhängig bewertet von weltweit führenden kryptografischen Laboren (BSI, ANSSI, NIST, Trail of Bits, Quarkslab, Kudelski).',
    'anonymizedRouting.badge': 'QUANTEN-MIXNET-ROUTING',
    'anonymizedRouting.title': 'Mehrstufiges Anonymisiertes Mixnet & Verkehrsabschirmung',
    'anonymizedRouting.subtitle': 'Sphinx-gekapseltes Onion-Routing über souveräne europäische Knoten zur Abwehr von Metadaten-Korrelation und Provider-Überwachung.',
    'latticeVsClassical.badge': 'VERGLEICH MATHEMATISCHER KOMPLEXITÄT',
    'latticeVsClassical.title': 'Gitterbasierte Kryptografie vs. Klassisches RSA/ECC',
    'latticeVsClassical.subtitle': 'Warum Learning With Errors (LWE) und Module-LWE absolute Sicherheit gegen den Shor-Algorithmus bieten, wo Primfaktorzerlegung versagt.',
    'academicAffiliations.badge': 'AKADEMISCHE KOOPERATION & FORSCHUNG',
    'academicAffiliations.title': 'Akademische Partnerschaften & Peer-Review',
    'academicAffiliations.subtitle': 'In Partnerschaft mit führenden europäischen und globalen Forschungsinstituten (INRIA, CNRS, ETH Zürich, MIT CSAIL) zur Validierung von Gitterrauschverteilungen.',
    'quantumReadiness.badge': 'ORGANISATORISCHER QUANTEN-AUDIT',
    'quantumReadiness.title': 'Organisatorischer Post-Quanten-Rechner',
    'quantumReadiness.subtitle': 'Bewerten Sie die Gefährdung Ihrer Organisation durch HNDL-Angriffe und erhalten Sie einen Migrationsplan gemäß NIST- und BSI-Richtlinien.',
    ...
    'hero.hl3Title': 'Contacts Privés',
    'hero.livePreviews': 'Aperçus de l\\\'application :',
    'hero.plainEnglishBody': 'Klassische Messenger (WhatsApp, Signal, Teams) nutzen RSA- und Elliptische-Kurven-Kryptografie, die durch zukünftige Quanten-Supercomputer im Rahmen von „Harvest Now, Decrypt Later“ (HNDL) nachträglich entschlüsselt werden. Q-CRYPT nutzt NIST FIPS 203 (ML-KEM-1024) Gitterverschlüsselung und Hardware-Sicherheitschips (Titan M2 / Knox), damit vertrauliche Vorstandsbeschlüsse, M&A-Projekte und Betriebsgeheimnisse für über 50 Jahre mathematisch geschützt bleiben.',
    'hero.plainEnglishTitle': 'Executive Overview: Post-Quanten-Resilienz & Schutz des Vorstands',
    'hero.sharedApp': 'Aperçu Partagé',
    ...
    'preflight.badge': 'HARDWARE-VORFLUGPRÜFUNG',
    'preflight.title': 'Sicherheits-Vorflugprüfung & Enklaven-Registrierung',
    'preflight.subtitle': 'Überprüft die Integrität des Hardware-Keystores (Titan M2/Knox) und registriert das Gerät im forensischen Manipulationsbuch.',
    'adversary.badge': 'QUANTEN-GEGNER-SIMULATOR',
    'adversary.title': 'Quanten-Gegner-Simulator & HNDL-Risiko-Engine',
    'adversary.subtitle': 'Reale Meilensteine des Quantencomputings im Vergleich zur Gitter-Härte und HNDL-Angriffsvektoren.',
    'hsmGuide.badge': 'FIPS 140-3 ARCHITEKTUR & BESCHAFFUNG',
    'hsmGuide.title': 'Hardware-Sicherheitsmodul (HSM) Auswahl-Leitfaden',
    'hsmGuide.subtitle': 'Technische Spezifikationen, Sicherheitsgrenzen und native Codebeispiele für Titan M2, YubiKey, Nitrokey und Cloud-HSMs.',
  },
  es: {
    'nav.polygonDid': 'Identidad Descentralizada (DID)',
    'polygonDid.badge': 'IDENTIDAD DESCENTRALIZADA ANCLADA EN POLYGON (PoS)',
    'polygonDid.title': 'Identidad Descentralizada y Huellas de Claves Post-Cuánticas',
    'polygonDid.subtitle': 'Prueba pública inmutable de propiedad de claves públicas en la cadena de bloques Polygon PoS. Cero fuga de metadatos, pruebas criptográficas de inclusión de Merkle y certificación soberana de enclave de hardware.',
    'realtimeDashboard.badge': 'PANEL DE TELEMETRÍA EN VIVO',
    'realtimeDashboard.title': 'Telemetría de Enclaves Criptográficos en Tiempo Real',
    'realtimeDashboard.subtitle': 'Monitoreo continuo de enclaves de hardware globales, negociaciones de claves reticulares y estado de túneles de conocimiento cero.',
    'publicVerification.badge': 'VERIFICACIÓN CRIPTOGRÁFICA PÚBLICA',
    'publicVerification.title': 'Verificador Público Independiente de Sesiones y Claves',
    'publicVerification.subtitle': 'Inspeccione y verifique pruebas de sesiones efímeras post-cuánticas, parámetros NIST FIPS 203 y pruebas de conocimiento cero en tiempo real.',
    'transparencyLedger.badge': 'REGISTRO DE AUDITORÍA INMUTABLE',
    'transparencyLedger.title': 'Libro Mayor de Transparencia Inmutable en Tiempo Real',
    'transparencyLedger.subtitle': 'Eventos de verificación encadenados criptográficamente con pruebas ZK, que demuestran inmunidad contra alteraciones sin exponer identidades.',
    'auditTrail.badge': 'PISTA DE AUDITORÍA DE SEGURIDAD INDEPENDIENTE',
    'auditTrail.title': '10 Auditorías Criptográficas e Informes de Verificación Técnica',
    'auditTrail.subtitle': 'Evaluado de forma independiente por laboratorios criptográficos líderes en el mundo (ANSSI, BSI, NIST, Trail of Bits, Quarkslab, Kudelski).',
    'anonymizedRouting.badge': 'ENRUTAMIENTO MIXNET CUÁNTICO',
    'anonymizedRouting.title': 'Mixnet Multisaltox Anonimizado y Blindaje de Tráfico',
    'anonymizedRouting.subtitle': 'Enrutamiento cebolla con paquetes criptográficos Sphinx a través de nodos soberanos europeos, eliminando la correlación de metadatos y la vigilancia de ISP.',
    'latticeVsClassical.badge': 'COMPARACIÓN DE COMPLEJIDAD MATEMÁTICA',
    'latticeVsClassical.title': 'Criptografía Reticular vs RSA/ECC Clásico',
    'latticeVsClassical.subtitle': 'Por qué Learning With Errors (LWE) y Module-LWE proporcionan seguridad inquebrantable contra el algoritmo de Shor donde la factorización de primos falla.',
    'academicAffiliations.badge': 'COLABORACIÓN ACADÉMICA E INVESTIGACIÓN',
    'academicAffiliations.title': 'Afiliaciones Académicas y Revisión Criptográfica por Pares',
    'academicAffiliations.subtitle': 'En colaboración con los principales institutos de investigación europeos y globales (INRIA, CNRS, ETH Zúrich, MIT CSAIL) para validar distribuciones de ruido e inmunidad de canal lateral.',
    'quantumReadiness.badge': 'AUDITORÍA DE PREPARACIÓN POST-CUÁNTICA',
    'quantumReadiness.title': 'Calculadora de Preparación Post-Cuántica Organizacional',
    'quantumReadiness.subtitle': 'Evalúe la exposición de su institución a los ataques HNDL y obtenga una hoja de ruta de migración inmediata según las directrices de NIST y ANSSI.',
    ...
    'hero.hl3Title': 'Contacts Privés',
    'hero.livePreviews': 'Aperçus de l\\\'application :',
    'hero.plainEnglishBody': 'Las aplicaciones estándar (WhatsApp, Signal, Teams) dependen de matemáticas RSA y curvas elípticas que serán descifradas retroactivamente por superordenadores cuánticos mediante ataques "Recolectar Ahora, Descifrar Después" (HNDL). Q-CRYPT implementa criptografía reticular NIST FIPS 203 (ML-KEM-1024) y enclaves de hardware (Titan M2 / Knox StrongBox) para garantizar que las deliberaciones del consejo, estrategias de fusiones y secretos corporativos permanezcan blindados por más de 50 años.',
    'hero.plainEnglishTitle': 'Resumen Ejecutivo: Resiliencia Post-Cuántica y Defensa Fiduciaria',
    'hero.sharedApp': 'Aperçu Partagé',
    ...
    'preflight.badge': 'VERIFICACIÓN PREVIA DE HARDWARE',
    'preflight.title': 'Lista de Verificación Previa de Seguridad y Registro',
    'preflight.subtitle': 'Verifica la integridad del almacén de claves de hardware (Titan M2/Knox) y registra el dispositivo en el libro mayor forense.',
    'adversary.badge': 'SIMULADOR DE ADVERSARIO CUÁNTICO',
    'adversary.title': 'Simulador de Adversario Cuántico y Motor de Riesgo HNDL',
    'adversary.subtitle': 'Hitos reales de computación cuántica correlacionados con la robustez reticular y vectores de ataque Cosechar Ahora, Descifrar Después.',
    'hsmGuide.badge': 'ARQUITECTURA Y SELECCIÓN FIPS 140-3',
    'hsmGuide.title': 'Guía de Selección de Módulos de Seguridad de Hardware (HSM)',
    'hsmGuide.subtitle': 'Especificaciones de ingeniería, límites de seguridad y ejemplos de código nativo para Titan M2, YubiKey, Nitrokey y HSMs en la nube.',
  },
};
